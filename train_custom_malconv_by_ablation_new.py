...
from secml_malware.smoothed_malconv import get_dataset, create_smoothed_malconv, modify_dataset_for_smoothed_malconv, \
    ...
    modify_dataset_for_smoothed_malconv_by_ablation
...
if __name__ == "__main__":
    ...
    main(args.mal_path, args.ben_path, args.dir_path, args.ablation_idx, args.dataset_size, args.ablations, args.epochs,
         args.batch_size)
